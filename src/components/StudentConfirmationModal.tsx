...
export function StudentConfirmationModal({ isOpen, onClose, onConfirmDelete, onConfirmBlock, studentName }: StudentConfirmationModalProps) {
  return (
      ...
      <DialogContent className="bg-[#111827] border-red-500/50 text-white max-w-md p-0">
        ...
        <div className="px-6 pb-6">
            <DialogDescription className="text-slate-400 mb-6">
                Are you sure you want to proceed with this action for the student "{studentName}"? This cannot be undone.
            </DialogDescription>
